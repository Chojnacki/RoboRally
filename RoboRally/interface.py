...
class Ui_interface_ihm(object):
    def setupUi(self, interface_ihm):
        ...
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(830, 620, 411, 232))
        ...
        self.bouton_distrib = QtGui.QPushButton(self.gridLayoutWidget_2)
        self.bouton_distrib.setObjectName(_fromUtf8("bouton_distrib"))
        self.gridLayout_2.addWidget(self.bouton_distrib, 0, 0, 1, 1)
    ...
    def retranslateUi(self, interface_ihm):
        ...
        self.plainTextEdit.setPlainText(_translate("interface_ihm", "Distribuez les cartes,\n"
"choisissez en 5 (ex: 0 8 3 1 5) entre 0 et 8\n"
